...
-- 3. 执行此脚本: source D:/Workspace/hogprice-insight/backend/init_schema.sql
-- 或者: mysql -u root -p < init_schema.sql
-- ========================================
...
-- ========================================
-- 11. 插入admin用户（密码: Admin@123）
-- 注意：密码hash需要通过Python生成
-- 运行: python get_password_hash.py 获取hash值
-- 然后替换下面的hash值
-- ========================================
...
SELECT 'Next step: Run python init_admin_user.py to create admin user' AS next_step;
