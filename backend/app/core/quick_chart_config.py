...
QUICK_CHART_PRECOMPUTE_URLS = [
    ...
    {"path": "/api/v1/price-display/region-spread/seasonality", "params": {"region_pair": "广东-广西"}},
    {"path": "/api/v1/price-display/live-white-spread/dual-axis", "params": {}},
    {"path": "/api/v1/price-display/industry-chain/seasonality", "params": {"metric_name": "仔猪价格"}},
